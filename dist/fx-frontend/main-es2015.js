...
let AuthComponent = class AuthComponent {
    ...
    loginUser(event) {
        ...
        this.Auth.userSignin(username, password).subscribe((data) => {
    ...
    registerUser(event) {
        ...
        this.Auth.registerNewUser(createEmail, username, createpassword).subscribe((data) => {
            sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
                title: "Success",
                text: data,
                icon: "success",
...
let BlogComponent = class BlogComponent {
    ...
    ngOnInit() {
        ...
        this.Auth.getBlogByCategory(id).subscribe((data) => {
...
let RecentComponent = class RecentComponent {
    ...
    ngOnInit() {
        this.Auth.getRecentBlogPost().subscribe((data) => {
